...
even_odd_string = ''
even_string = 'translate <1.0, 0, 0>'    # mandatory shift for triangle pattern, uneditable
odd_string = ''    # consider 'rotate<0.0, 0.0, 180.0>' or scale <1.0, -1.0, 1.0>
