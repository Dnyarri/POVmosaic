...
Module for converting bitmap images into `6³`_ mosaic of 3D objects in `POV-Ray`_ format.

Exported 3D scene contain base mosaic 3D elements (spheres, polyhedra, hexagonal prisms, etc.)
packed as *hexagonal* Euclidean tiling, colored after original image pixel
...
5. `POV-Ray Mosaic 6³`_ illustrated.
