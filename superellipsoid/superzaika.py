...
#
# 01.000    superellipsoid-4zaika.py Initial release
#
#       Project mirrors:
...
resultfile.write('// Auth: Automatically generated by superellipsoid-4zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
for y in range(0, Y, 1):
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):             # whether to draw thingie in place of partially transparent pixel or not
            ...
            # resultfile.write(f'<{random.random()}, {random.random()}>')   # randoms using Python
