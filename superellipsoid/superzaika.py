...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description:  Mosaic picture consisting from superellipsoids, C4 symmetry (square) packing with random parameters\n',
                       'Author: Automatically generated by superzaika program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
...
resultfile.writelines(['\n// Thingie properties - common\n',
                       ...
                       '#declare xysize = 0.5;          // x,y-Size value for all thingies; default 0.5 since superellipsoid fits -1..1\n\n',
...
for y in range(0, Y, 1):
    ...
    for x in range(0, X, 1):
        ...
        normalizedx = float(x)/float(X)
        normalizedy = float(y)/float(Y)    # x,y normalized to 0..1
        ...
        if (a > tobeornottobe):
            ...
            # randoms using POVRay
            resultfile.write('<rand(normalrand), rand(normalrand)>')
            ...
            # legacy close pigment without normal
