...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description: Mosaic picture consisting from solid triangle prisms, C3 symmetry (triangle) packing whose height corresponds to source image brightness\n',
                       'Author: Automatically generated by p3zaika program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
...
# Height of tringie with 2*1 sides. sqrt(3) = 1.732... hardcoded to remove math export
thingieheight = 1.7320508075688772935274463415059
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):
            ...
            if (((x+1) % 2) == 0):
                ...
                resultfile.write(' scale <1.0, -1.0, 1.0>')
