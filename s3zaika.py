...
Program for conversion of image into a C3 symmetry set of tightly packed spheres,
...
01.002  Normal added, per-thingie rotated based on POVRay random.
...
resultfile.write('// Description: Mosaic picture consisting from solid spheres, C3 symmetry (triangle) packing\n')
resultfile.write('// Auth: Automatically generated by s3zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
triangleheight = 0.5 * 1.7320508075688772935274463415059 # Height of tringle with 2*0.5 sides, that is the distance between two 0.5 radius spheres as defined by thingie. sqrt(3) = 1.732... hardcoded to remove math export
