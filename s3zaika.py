...
resultfile.write('// Description: A mosaic picture consisting from a solid spheres\n')
...
triangleheight = 0.5 * math.sqrt(3) # Height of tringle with 2*0.5 sides, that is the distance between tho 0.5 radius spheres as defined by thingie
...
resultfile.write(f'scale <-1.000000/{max(X,Y)}, -1.000000/{max(X,Y)}, 1.000000/{max(X,Y)}>\n')  # rescale, mirroring POV coordinates to match Photoshop coordinate system
