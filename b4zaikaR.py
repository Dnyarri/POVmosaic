...
resultfile.write('// Description: Mosaic picture consisting from solid boxes, C4 symmetry (square) packing,\n// rotated according to source brightness and/or random. See rotate_ settings')
resultfile.write('// Auth: Automatically generated by b4zaikaR program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
for y in range(0, Y, 1):
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):             # whether to draw thingie in place of partially transparent pixel or not
            ...
            resultfile.write(f' rotate <rotate_random*{45.0*random()},rotate_random*{45.0*random()},rotate_yarkost*{45.0*yarkost}>')
