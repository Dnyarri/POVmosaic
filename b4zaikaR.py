...
'''
POV Box Mosaic, square pattern, rotated boxes artwork
...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description: Mosaic picture consisting from solid boxes, C4 symmetry (square) packing, rotated according to source brightness and/or random. See rotate_ settings\n',
                       'Author: Automatically generated by b4zaikaR program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
...
# Thingie element
resultfile.writelines(['\n// Object thingie\n',
                       '#declare thingie = box {<-0.5, -0.5, 0.0>, <0.5, 0.5, 1.0>}\n',
                       ...
                       '#declare rotate_random = 0.75;  // Rotate multiplier for random. 1.0 correspond to 45 deg\n',
                       '#declare rotate_yarkost = 2.0;  // Rotate multiplier for brightness. 1.0 correspond to 45 deg\n',
                       '#declare xyzsize = 1.0;         // x,y,z-Size value for all thingies\n\n',
...
for y in range(0, Y, 1):
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):
            ...
            resultfile.write(f' rotate <rotate_random*{45.0*random()},rotate_random*{
                             45.0*random()},rotate_yarkost*{45.0*yarkost}>')
