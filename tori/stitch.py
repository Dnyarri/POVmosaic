...
resultfile.write('// Description: Mosaic picture simulating cross-stitching\n')
resultfile.write('// Auth: Automatically generated by stitch.py program\n')
...
resultfile.write('#declare threadthikness = 0.1;     // higher than 1.5 not recommended\n')
resultfile.write('#declare randomXrotation = 10.0;   // range of random stitch rotations, degree\n')
resultfile.write('#declare bublik = torus {0.5, threadthikness\n    scale <1.0, 2.0, 1.0>\n    rotate x*45\n}\n')
resultfile.write('// Balance second torus radius (currently linked to threadthikness) and scale<> carefully!\n\n')
...
resultfile.write('#declare normalheight = 0.5;     // Normal intensity\n')
resultfile.write('#declare normalangle = 15;       // Normal is rotated at this angle around z, degrees\n')
resultfile.write('#declare normalanglerange = 15;  // Normal rotation angle randomy varies within this range, deg\n\n')
...
normalstring = ('normal {spiral1 5, normalheight scallop_wave scale <0.1, 0.1, 1.0> rotate x*90 rotate z*(normalangle+normalanglerange*(rand(normalrand)-0.5))}')
...
for y in range(0, Y, 1):
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):             # whether to draw thingie in place of partially transparent pixel or not
            ...
            resultfile.write(rotatestring)                  # randomized rotation
            resultfile.write(' scale <(1.0-threadthikness), 1.0, 1.0> ')    # these strings differ for upper and lower!
            ...
            resultfile.write(rotatestring)                  # randomized rotation
            resultfile.write(' scale <(1.0+threadthikness), 1.0, 1.0> rotate x*90 ')    # these strings differ for upper and lower!
