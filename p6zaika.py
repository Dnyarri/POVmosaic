# POV Prizm Mosaic, hexagonal pattern
# Program for conversion of image into a C6 symmetry set of tightly packed hexagon prizms,
...
#
# 01.000    p6zaika.py Initial release
# 01.001    Major bugfix
#
#       Project mirrors:
...
resultfile.write('// Description: Mosaic picture consisting from solid hexagonal prisms, C6 symmetry (honey comb) packing\n')
resultfile.write('// Auth: Automatically generated by p6zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
resultfile.write('#declare revsqrtof3 = 1.0/sqrtof3;    // 1.0/sqrt(3)\n')
resultfile.write('#declare thingie = prism {linear_sweep linear_spline 0, 1, 7, <-0.5, 0.5*revsqrtof3>, <0,revsqrtof3>, <0.5, 0.5*revsqrtof3>, <0.5,- 0.5*revsqrtof3>, <0,-revsqrtof3>, <-0.5,- 0.5*revsqrtof3>, <-0.5, 0.5*revsqrtof3> rotate x*90}\n') # Hexagonal prism 1.0 high 0.5 radius
...
thingieheight = 0.5 * 1.7320508075688772935274463415059 # Height of tringie with 2*0.5 sides, that is the distance between two 0.5 internal radius thingies as defined by thingie. sqrt(3) = 1.732... hardcoded to remove math export

translatestring = ' '
oddtranslatestring = ' '  # no offset
eventranslatestring = ' translate <0.5, 0, 0> ' # 0.5 x offset for honeycomb packing
