...
resultfile.write('// Description: Mosaic picture consisting from solid spheres, C4 symmetry (square) packing\n')
resultfile.write('// Auth: Automatically generated by s4zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
