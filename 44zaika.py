...
sourcefilename = filedialog.askopenfilename(title='44zaika: Open source PNG file', filetypes=[('PNG', '.png')], defaultextension=('PNG', '.png'))
...
resultfilename = filedialog.asksaveasfilename(
    title='44zaika: Save POVRay scene file',
    filetypes=[
