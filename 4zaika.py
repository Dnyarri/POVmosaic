...
resultfile.writelines(['/*\n',
    ...
    '             Other possible objects include cylinders and spheres,\n',
...
resultfile.writelines([
        ...
        '#declare thingie_finish2 = Dull  // Example of simple finish from finish.inc\n',
        '#declare thingie_finish3 = F_MetalE  // Example of complex finish from golds.inc\n',
...
even_odd_string = ''
even_string = 'translate brickwall_offset   // Even row'
