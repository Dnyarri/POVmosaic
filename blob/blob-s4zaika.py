...
resultfile.write('// Description: Mosaic picture, blob consisting from solid spheres, C4 symmetry (square) packing\n')
resultfile.write('// Auth: Automatically generated by blob-s4zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
resultfile.write('// weird at blobblobness = 1.0 blobradius = 2.0\n')
...
resultfile.write('    threshold 4.5\n')
