...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description:  Mosaic picture, blob consisting from solid spheres, C4 symmetry (square) packing\n',
                       'Author: Automatically generated by blob-s4zaika program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
