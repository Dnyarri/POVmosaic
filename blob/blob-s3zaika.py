# POV Sphere Mosaic, triangle pattern
# Program for conversion of image into a C3 symmetry blob of tightly packed spheres,
...
#
# 01.000    blob-s3zaika.py Initial release
...
resultfile.write('// Description: Mosaic picture, blob consisting from solid spheres, C3 symmetry (triangle) packing\n')
resultfile.write('// Auth: Automatically generated by blob-s3zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
# Thingie element
resultfile.write('\n// Thingie properties\n')
resultfile.write('#declare blobradius = 0.8;\n') # Sphere radius.
resultfile.write('#declare blobblobness = 8.0;\n')
resultfile.write('// for fun change blobblobness = 1.0\n// then change blobradius = 2.0\n')
...
resultfile.write('#declare displace_factor = 0.25;   // z-Displace multiplier for all thingies. 0.0 makes strict plane output; 1.0 and higher not recommended\n')
resultfile.write('#declare xyzsize = 1.0;  // x,y,z-Size multiplier for all thingies, does not affect packing. Default 1.0\n\n')
...
resultfile.write('#declare normalanglerange = 15;  //Normal stretching angle randomy varies within this range, deg\n')
...
resultfile.write('#declare thething = blob {\n')  # Opening object "thething"
resultfile.write('    threshold 5.5\n')
...
for y in range(0, Ycount, 1):
    ...
    for x in range(0, X, 1):
        ...
        r = float(src(x,y*triangleheight,0))/maxcolors; g = float(src(x,y*triangleheight,1))/maxcolors; b = float(src(x,y*triangleheight,2))/maxcolors    # Normalize colors to 0..1.0
        ...
        if (a > tobeornottobe):             # whether to draw thingie in place of partially transparent pixel or not
            ...
            resultfile.write('}\n')         # Closing thingie after modifications
...
resultfile.write(f', camera_height))) // Supposed to fit object \n    look_at <0.0, 0.0, 0.0>')
resultfile.write('\n}\n\n')
