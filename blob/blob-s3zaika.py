...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description:  Mosaic picture, blob consisting from solid spheres, C3 symmetry (triangle) packing\n',
                       'Author: Automatically generated by blob-s3zaika program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
...
# Thingie element
resultfile.writelines(['\n// Thingie properties\n',
                       '#declare blobradius = 0.8;\n',  # Sphere radius.
                       '#declare blobblobness = 8.0;\n',
                       ...
                       '#declare displace_factor = 0.25;    // z-Displace multiplier for all thingies. 0.0 makes strict plane output; 1.0 and higher not recommended\n',
                       '#declare xyzsize = 1.0;         // x,y,z-Size multiplier for all thingies, does not affect packing. Default 1.0\n\n',
                       ...
                       '#declare normalanglerange = 15; // Normal stretching angle randomly varies within this range, deg\n\n'
                       ])
...
# Height of thingie with 2*0.5 sides, that is the distance between two 0.5 radius spheres as defined by thingie. sqrt(3) = 1.7320508075688773 hardcoded to remove math export
...
for y in range(0, Ycount, 1):
    ...
    for x in range(0, X, 1):
        ...
        if (a > tobeornottobe):
            # Opening thingie
            resultfile.write(
                '    sphere{<0,0,0>, blobradius, blobblobness pigment {')
            resultfile.write(
...
resultfile.write(
    f', camera_height))) // Supposed to fit object \n    look_at <0.0, 0.0, 0.0>')
resultfile.write('\n}\n\n')
