...
resultfile.write('// Description: Mosaic picture consisting from solid boxes, C4 symmetry (square) packing\n// those height corresponds to source image brightness\n')
resultfile.write('// Auth: Automatically generated by b4zaikaS program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
