...
resultfile.writelines(['/*\n',
                       ...
                       'Version: 3.7\n',
                       'Description: Mosaic picture consisting from solid boxes, C4 symmetry (square) packing whose height corresponds to source image brightness\n',
                       'Author: Automatically generated by b4zaikaS program, based on AmphiSoft POV Sphere Mosaic plug-in, see POVRay Mosaic project at\n',
                       'https://github.com/Dnyarri/POVmosaic\n',
                       'https://gitflic.ru/project/dnyarri/povmosaic\n',
...
resultfile.writelines(['\n// Object thingie\n',
                       ...
                       '#declare zsize_factor = 1.0;    // z-Size multiplier for all thingies\n',
                       '#declare xysize = 1.0;          // x,y-Size value for all thingies\n\n',
