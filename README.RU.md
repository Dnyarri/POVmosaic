...
- **superellipsoid/superellipsoid-4zaika.py** - конвертирует каждый пиксель в 3D-суперэллипсоид. Параметры суперэллипсоида случайны, что обеспечивает 3D-фигуры в диапазоне от сферы до куба через цилиндры и пирамиды. В целом эффект скорее попсовый, нежели высокохудожественный, но всегда можно попробовать побаловаться с параметрами.
