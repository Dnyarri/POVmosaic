...
resultfile.writelines(['/*\n',
    ...
    '             Other possible objects include cylinders and hexagonal prisms,\n',
    '             see list "#declare thingie1=" and below.\n',
...
resultfile.writelines([
        ...
        '#declare thingie3 = prism{linear_sweep linear_spline 0, 1, 7,\n <-0.5, 0.5*revsqrtof3>, <0,revsqrtof3>, <0.5, 0.5*revsqrtof3>, <0.5,- 0.5*revsqrtof3>, <0,-revsqrtof3>, <-0.5,- 0.5*revsqrtof3>, <-0.5, 0.5*revsqrtof3>\n rotate x*90}\n',
