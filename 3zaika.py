...
0.0.01      Complete rewriting to more flexible project - 22 May 2024.
...
resultfile.writelines([
        ...
        '#declare thingie3 = prism{linear_sweep linear_spline 0, 1, 7, <-0.5, 0.5*revsqrtof3>, <0,revsqrtof3>, <0.5, 0.5*revsqrtof3>, <0.5,- 0.5*revsqrtof3>, <0,-revsqrtof3>, <-0.5,- 0.5*revsqrtof3>, <-0.5, 0.5*revsqrtof3> rotate x*90}\n',
        # Trigonal prism 2.0 wide sqrtof3 tall
        # '#declare thingie4 = prism{linear_sweep linear_spline 0, 1, 4, <-1.0, sqrtof3div2>, <1.0, sqrtof3div2>, <0, -sqrtof3div2>, <-1.0, sqrtof3div2> rotate x*90}\n',
...
for y in range(0, Ycount, 1):
    ...
    if (((y+1) % 2) == 0):
        translate_x = eventranslate_x
    else:
        translate_x = oddtranslate_x
    ...
    for x in range(0, X, 1):
        ...
        if tobe_or_nottobe:
            ...
            resultfile.writelines([
                ...
                f'      translate<{x+translate_x}, {y*triangle_height}, 0>\n',
                '    }\n'
            # Finished thingie
            ])
