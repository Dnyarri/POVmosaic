...
resultfile.write('// Description: Mosaic picture consisting from solid cylinders, C3 symmetry (triangle) packing\n')
resultfile.write('// Auth: Automatically generated by c3zaika program, based on AmphiSoft POV Sphere Mosaic plug-in \n\n')
...
for y in range(0, Ycount, 1):
    ...
    for x in range(0, X, 1):
        ...
        zsize = zsize - 0.1*yarkost*random()     # furher adding random to z-scaling, keeping 0..1 range
